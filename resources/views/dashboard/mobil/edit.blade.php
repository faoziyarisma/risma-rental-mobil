...
@section('container')
    ...
    <div class="container-fluid isian-db">
        ...
        {{-- informasi --}}
        <p class="mb-3">Mengedit data mobil.</p>

        {{-- form --}}
        <div class="card shadow my-4 w-75">
            <div class="card-header py-2">
                <h6 class="my-2 bg-light table-name">Form Edit Data Mobil</h6>
            </div>
            <div class="card-body px-lg-3 mt-4">
                <form action="/dashboard/mobils/{{ $mobil->id }}" enctype="multipart/form-data" method="post">
                @method('put')    
                @csrf
                    <!-- merek -->
                    <div class="row mb-3">
                        ...
                        <div class="col-md-7 col-sm-12">
                            <input class="form-control form-control-user @error('merek') is-invalid @enderror" type="text" id="merek" name="merek"
                                value="{{ old('merek', $mobil->merek) }}" autofocus>
                            @error('merek')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-7 col-sm-12">
                            <input class="form-control form-control-user @error('model') is-invalid @enderror" type="text" id="model" name="model"
                                value="{{ old('model', $mobil->model) }}" autofocus>
                            @error('model')
                                <div class="small text-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-7 col-sm-12">
                            <input class="form-control form-control-user @error('no_plat') is-invalid @enderror" type="text" id="no_plat" name="no_plat"
                                value="{{ old('no_plat', $mobil->no_plat) }}" autofocus>
                            @error('no_plat')
                                <div class="small text-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-7 col-sm-12">
                            <input class="form-control form-control-user" type="number" id="tarif_per_hari" name="tarif_per_hari"
                                value="{{ old('tarif_per_hari', $mobil->tarif_per_hari) }}" required>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <button class="btn btn-primary text-white me-md-4 my-3" type="submit">Edit Data</button>
                    </div>
                </form>
            </div>
        </div>
